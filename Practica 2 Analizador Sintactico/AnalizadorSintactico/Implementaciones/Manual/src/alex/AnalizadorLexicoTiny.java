...
//               break;
           ...
           case REC_MAS:
               ...
               break;
           case REC_AMPERS:
        	   if (hayAmpers()) transita (Estado.REC_AMPERS2); // ojo a esto, que pasa si hay &&34 transita (Estado.REC_AMPERS2);
   //     	   else transita(Estado.REC_ID);
        	   break;
           case REC_MENOS: 
               if (hayDigitoPos()) transita(Estado.REC_ENT);
               else if(hayCero()) transita(Estado.REC_0);
...
//   }    
   ...
   public static void main(String arg[]) throws IOException {
     Reader input = new InputStreamReader(new FileInputStream("C:\\hlocal\\pl.txt"));
